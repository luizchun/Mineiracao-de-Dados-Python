...
def plot_confusion_matrix(cm, SEXOs,
                          normalize=False,
    ...
    plt.title(title)
    plt.colorbar()
    tick_marks = np.arange(len(SEXOs))
    plt.xticks(tick_marks, SEXOs, rotation=45)
    plt.yticks(tick_marks, SEXOs)
...
def main():
    ...
    plot_confusion_matrix(cm, ['Homem', 'Mulher', '?'], False,
                          "Confusion Matrix - K-NN")
    plot_confusion_matrix(cm, ['Homem', 'Mulher', '?'], True,
