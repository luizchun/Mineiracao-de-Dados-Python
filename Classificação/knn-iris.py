...
def main():
    ...
    features = ['CLASSE','IDADE' ,'SEXO' , 'ESTEROIDE' , 'ANTIVIRAIS' , 'FADIGA' , 'MAL-ESTAR' , 'ANOREXIA' , 'GRANDE FIGADO' , 'FIGADO' , 'BATIDO' , 'ARANHAS' , 'ASCITAS' , 'VARICES' , 'BILIRRUBINA' , 'ALBUMINA' , 'HISTOLOGIA']
